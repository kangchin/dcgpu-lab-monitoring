...
class ConductorSystems(object):
    def __init__(self):
        ...
        self.collection_name = "conductor_systems"  # separate collection
        ...
        self.create_optional_fields = ["site", "location", "bmc_ip", "username", "password"]

        self.update_required_fields = []
        self.update_optional_fields = ["system", "site", "location", "bmc_ip", "username", "password", "updated"]
