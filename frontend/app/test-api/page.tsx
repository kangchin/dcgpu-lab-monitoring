      ...
      <div className="max-w-6xl mx-auto">
        ...
        {result && (
          <div className="bg-white dark:bg-gray-900 rounded-lg shadow-lg p-6">
            ...
            {/* PDU Info Display (if single PDU response) */}
            {result.pdu_info && !result.sync_result && (
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 dark:text-gray-400 font-mono text-sm">
                      {result.pdu_info.ip_address || "N/A"}
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 dark:text-gray-400 font-mono text-sm">
                      {result.pdu_info.manufacturer || "N/A"}
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 dark:text-gray-400 font-mono text-sm">
                      {result.pdu_info.serial_number || "N/A"}
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 dark:text-gray-400 font-mono text-sm">
                      {result.pdu_info.mac_address || "N/A"}
                    </p>
                  </div>
                </div>
